...
void vista_modo_operacion(void) {
    ...
    LCD_Cmd(_LCD_CLEAR);
    __delay_ms(50);
    if (setpoint_rpm > 0 && (horas > 0 || minutos > 0)) {
        operationModeFlag = 1;
    } else {
        LCD_Cmd(_LCD_CLEAR);
        __delay_ms(50);
...
void vista_modo_setpoint_rpm(void) {
    ...
    while (vista == 2) {
        //        sprintf(aux, "   Set RPM -> %d%d%d%d", setpoint_rpm);
...
//    LCD_Cmd(_LCD_CLEAR);
//    __delay_ms(50);
//    vista_firing_angle_flag = 1;
//    while (vista == 5) {
//        LCD_Out(2, 1, "     Test speed");
//        sprintf(aux, " firing angle -> %03d", valorAnguloDisparo);
//        LCD_Out(3, 1, aux);
//        LCD_XY(3, 20);
//        LCD_Cmd(_LCD_UNDERLINE_ON);
//        __delay_ms(150);
...
//            LCD_Out(3, 1, aux);
//            valorAnguloDisparo++;
//            if (valorAnguloDisparo > 100) {
//                valorAnguloDisparo = 0;
//            }
//            __delay_ms(50);
//        }
//        while (!PORTBbits.RB5) {
...
//            LCD_Out(3, 1, aux);
//            valorAnguloDisparo--;
//            if (valorAnguloDisparo < 0) {
//                valorAnguloDisparo = 100;
//            }
//            __delay_ms(50);
//        }
//    }
...
void vista_sintonizar_pid(void) {
    ...
    while (vista == 5) {
        sprintf(aux, "kp=%03d ki=%03d kd=%03d", kp, ki, kd);
        LCD_Out(2, 1, aux);
        LCD_XY(2, posicion_cursor);
        LCD_Cmd(_LCD_UNDERLINE_ON);
        __delay_ms(150);
